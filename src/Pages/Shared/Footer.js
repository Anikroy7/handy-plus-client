...
const Footer = () => {
    return (
        <footer>
            ...
            <section class="footer grid-rows-2 p-10 bg-neutral text-neutral-content mt-40">
                <div>
            ...
            <section class="footer items-center p-4 bg-neutral text-neutral-content">
                <div class="items-center grid-flow-col">
                    <span>Handy Plus</span>
