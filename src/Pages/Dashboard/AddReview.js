    ...
    return (
        <div className='w-72 bg-slate-400 mx-auto p-14'>
            ...
            <form onSubmit={handelAddReview}>
                <input type="text" name='name' placeholder="Type your name" class="input input-bordered w-full max-w-xs mb-2" />
                <input type="text" name='description' placeholder="Type your description" class="input input-bordered mb-2 w-full max-w-xs" />
                <input type="text" name='ratings' placeholder="Your ratings" class="input input-bordered w-full mb-2 max-w-xs" />
